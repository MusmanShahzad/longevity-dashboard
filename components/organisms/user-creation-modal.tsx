...
const ModalHeader = ({ onClose }: { onClose: () => void }) => (
  <div className="flex items-center justify-between mb-6">
    <div className="flex items-center space-x-3">
      ...
      <div>
        <h2 className="text-2xl font-bold text-white">Create User Profile</h2>
        <p className="text-sm text-cyan-300">Set up a new health tracking profile</p>
      </div>
    </div>
    <Button
      variant="ghost"
              ...
              <div className="flex-shrink-0 p-6 border-t border-white/10">
                <div className="flex flex-col sm:flex-row gap-3">
                  ...
                  <Button
                    ...
                    disabled={createUserMutation.isPending || !formik.isValid || !formik.dirty}
                  >
